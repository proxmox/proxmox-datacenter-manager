...
const CHALLENGE_DATA_PATH: &str = pdm_buildcfg::rundir!("/tfa/challenges");

pub fn read_lock() -> Result<ApiLockGuard, Error> {
    open_api_lockfile(LOCK_FILE, None, false)
}

pub fn write_lock() -> Result<ApiLockGuard, Error> {
...
impl UserChallengeAccess for TfaUserChallengeData {
